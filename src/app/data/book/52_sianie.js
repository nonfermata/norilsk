...
const sianie = {
    ...
    chapters: [
        ...
        },
        {
            ...
            text: [
                'Однажды в феврале мы с друзьями вышли на улицу после очередного занятия в Медиашколе. Время позднее, мне домой через час, Софа и я провожаем домой Полину. На улице темно и холодно. Мы свернули во двор и вдруг увидели прекрасное голубое северное сияние — эту беззвучную музыку неба. Оно было прямо над нами и простиралось в разные стороны. Недолго думая, мы легли на снег прямо посреди двора; задавит нас машина или нет — нам было все равно, будто мы дети лет семи. Мы лежали и болтали, в моем кармане завибрировал телефон — аккумулятор сел, связи с родителями нет, надо идти, но хочется растянуть это восхитительное беззаботное мгновение. «Что скажет мама, когда я вернусь так поздно? Я подумаю об этом утром», — мысленно сказал я себе.',
