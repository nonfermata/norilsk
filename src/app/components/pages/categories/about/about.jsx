                ...
                {subCutName ? (
                    ...
                    <>
                        ...
                        <div className={classes.thanks}>
                            ...
                            искреннюю благодарность за многолетнюю поддержку и
                            помощь департаменту общественных связей компании
                            «Норникель», медиакомпании «Северный город» и лично
                            Андрею Кирпичникову, Сергею Панченко, Татьяне
                            Смирновой, Занде Бусловой, Вере Калабековой, Артуру
                            Калабекову и Вере Скорницкой!
                        </div>
                        <div className={classes.dedication}>
                            Эту книгу мы посвящаем памяти нашего большого друга
